...
public class LottoMain {
	...
	public static void main(String[] args) {
		...
		for ( int i = 0; i < 10; i++)
		{
			...
			{
				numbersCnt[myLotto.lotto[j]-1] ++; //= myLotto.lotto[j]; 6개의 번호
		...
		System.out.println("의 숫자가" +max+"번 불렸습니다.");
	}
...
class Lotto
{
	...
	int[] generateNumber()
	{
		...
		while ( i<6)
		{
			int rndNum = (int)(Math.random()*45+1); //1-45사이의 값
			boolean isDup = false;
